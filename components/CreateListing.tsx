...
export const CreateListing: React.FC<{ listingToUpdate?: Listing }> = ({
  ...
  useEffect(() => {
    ...
    setName(listingToUpdate.name);
    setAddress(listingToUpdate.address);
    setCategory(listingToUpdate.category);
    setDescription(listingToUpdate.description);
    setEmail(listingToUpdate.email);
    setPhone(listingToUpdate.phone);
    setWebsite(listingToUpdate.website);
  }, [listingToUpdate]);
